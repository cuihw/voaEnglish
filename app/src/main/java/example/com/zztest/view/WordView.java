package example.com.zztest.view;
...
import example.com.zztest.utils.LrcParser;
...
public class WordView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float wordWidth = p2.measureText(linestr);

        int widthbounds = bounds.width();

        if (wordWidth > width) {
            int lines = (int)(wordWidth)/width + 1;
        } else {
    ...
    private int computeStringWidth(String string, Paint p) {
